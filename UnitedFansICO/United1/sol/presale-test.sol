...
contract Presale is SafeMath, Pausable {
    ...
    function Presale() {     
        ...
        multisigETH = 0x239D115b0938F045B95d494BE5a286ea31F222ec; //TODO: Replace address with correct one
        maxCap = 10000 * multiplier;  // max amount of tokens to be sold
        SOCXSentToETH = 0;              // tokens sold so far
        minInvestETH = 1 ether;         // minimum investment acceptable
        ...
        tokenPriceWei = 500000000000000;// price of token expressed in Wei 
    }
    ...
    function start(uint _block) onlyBy(owner) {
        ...
        endBlock = startBlock + _block; //TODO: Replace for actual deployment
