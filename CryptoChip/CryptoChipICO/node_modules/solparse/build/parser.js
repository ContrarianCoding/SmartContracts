...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c152 = "experimental",
      peg$c153 = peg$literalExpectation("experimental", false),
      peg$c154 = "export",
      peg$c155 = peg$literalExpectation("export", false),
      peg$c156 = "extends",
      peg$c157 = peg$literalExpectation("extends", false),
      peg$c158 = "false",
      peg$c159 = peg$literalExpectation("false", false),
      peg$c160 = "finney",
      peg$c161 = peg$literalExpectation("finney", false),
      peg$c162 = "for",
      peg$c163 = peg$literalExpectation("for", false),
      peg$c164 = "from",
      peg$c165 = peg$literalExpectation("from", false),
      peg$c166 = "function",
      peg$c167 = peg$literalExpectation("function", false),
      peg$c168 = "get",
      peg$c169 = peg$literalExpectation("get", false),
      peg$c170 = "hex",
      peg$c171 = peg$literalExpectation("hex", false),
      peg$c172 = "hours",
      peg$c173 = peg$literalExpectation("hours", false),
      peg$c174 = "if",
      peg$c175 = peg$literalExpectation("if", false),
      peg$c176 = "is",
      peg$c177 = peg$literalExpectation("is", false),
      peg$c178 = "indexed",
      peg$c179 = peg$literalExpectation("indexed", false),
      peg$c180 = "import",
      peg$c181 = peg$literalExpectation("import", false),
      peg$c182 = "interface",
      peg$c183 = peg$literalExpectation("interface", false),
      peg$c184 = "internal",
      ...
      peg$c246 = function() { return { type: "ThisExpression", start: location().start.offset, end: location().end.offset }; },
      peg$c247 = "(",
      ...
      peg$c282 = function(literal, members, parts) {
          return {
            type: "Type",
      ...
      peg$c287 = function(expression) {
          return expression;
        },
      peg$c288 = function(type, specifiers, id, value) {
          return {
      ...
      peg$c289 = function(type, storage, id) {
          return {
      ...
      peg$c293 = function(argument, operator) {
            return {
      ...
      peg$c298 = function(operator, argument) {
      ...
      peg$c307 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c308 = "*",
      ...
      peg$c354 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c381 = function(head, tail, init) {
            return {
              declarations: buildList(head, tail, 1),
              init: extractOptional(init, 1)
            }
          },
      peg$c382 = function(id) {
            return {
      ...
      peg$c384 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      peg$c385 = function(expression) {
            return {
      ...
      peg$c386 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c387 = function(test, consequent) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c388 = function(start_version, end_version) {
          return {
      ...
      peg$c392 = function(symbols, from) {
          return {
            type: "ImportStatement",
            from: from.value,
            symbols: symbols,
      ...
      peg$c393 = function(library, type) {
          return {
            type: "UsingStatement",
      ...
      peg$c397 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test, start: location().start.offset, end: location().end.offset }; },
      peg$c398 = function(test, body) { return { type: "WhileStatement", test: test, body: body, start: location().start.offset, end: location().end.offset }; },
      peg$c399 = function(init, test, update, body) {
            return {
              type:   "ForStatement",
      ...
      peg$c400 = function(declarations, test, update, body) {
            return {
              type:   "ForStatement",
              init:   {
                type:         "VariableDeclaration",
      ...
      peg$c401 = "assembly",
      peg$c402 = peg$literalExpectation("assembly", false),
      peg$c403 = function(body) {
            return {
      ...
      peg$c416 = function(fnname, isanonymous) {
          return {
      ...
      peg$c417 = function(fnname, names, body) {
            return {
      ...
      peg$c418 = function(fnname, args, returns, body) {
            return {
      ...
      peg$c419 = function(fnname, args, returns) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c420 = function(params) {
          return params != null ? params [2] : null;
        },
      peg$c421 = function(id, params) {
          return {
            type: "FunctionName",
      ...
      peg$c424 = function(type, isindexed, isconstant, isstorage, ismemory, id) {
          return {
      ...
      peg$c426 = function(id, head, tail) {
          return {
      ...
      peg$c431 = "let",
      peg$c432 = peg$literalExpectation("let", false),
      peg$c433 = ":=",
      peg$c434 = peg$literalExpectation(":=", false),
      peg$c435 = function(name, expression) {
          return {
      ...
      peg$c436 = function(name, expression) {
          return {
      ...
      peg$c441 = function(name, head, tail) {
          return {
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          peg$savedPos = s0;
                          s1 = peg$c424(s1, s3, s5, s7, s9, s11);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$FAILED;
